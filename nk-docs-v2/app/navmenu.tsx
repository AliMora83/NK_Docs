    ...
    <div>
        <aside className="h-full p-6 sm:w-60 dark:bg-[#080a0b] dark:text-gray-100 fixed">
            <nav className="space-y-8 text-sm pt-5">
              ...
              <div className="space-y-2">
                <h2 className="text-sm font-semibold tracking-widest uppercase dark:text-gray-400">General Use</h2>
                <div className="flex flex-col space-y-1">
                  <Link href="user">User Guide</Link>
                  ...
                  <a className='a' rel="noopener noreferrer" href="#tickets">Buy Tickets</a>
                  <a className='a' rel="noopener noreferrer" href="#wait">Wait for Draw</a>
                  <a className='a' rel="noopener noreferrer" href="#check">Check Winnings</a>
                  <a className='a' rel="noopener noreferrer" href="#faq">FAQ's</a>
                </div>
              </div>
              <div className="space-y-2">
                <h2 className="text-sm font-semibold tracking-widest uppercase dark:text-gray-400">Corporate</h2>
                <div className="flex flex-col space-y-1">
                  <a className='a' rel="noopener noreferrer" href="#addToWeb">Add to Website</a>
                  <a className='a' rel="noopener noreferrer" href="#hero">Add Hero Banner</a>
              ...
              <div className="space-y-2">
                <h2 className="text-sm font-semibold tracking-widest uppercase dark:text-gray-400">Internal Team</h2>
                <div className="flex flex-col space-y-1">
